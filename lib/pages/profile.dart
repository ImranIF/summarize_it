...
class _ProfileState extends State<Profile> {
  ...
  Widget buildHeader(User user) {
    return Column(
      children: [
                              ...
                              children: [
                                Text(
                                  ...
                                  style: GoogleFonts.georama(
                                    fontSize: 20,
                                    color:
                                        const Color.fromARGB(255, 35, 141, 123),
                                    // ,
                ...
                Container(
                  ...
                  child: InkWell(
                      onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const AppRating())),
                      child: Ink(
                        child: const Icon(Icons.stars_sharp,
                            size: 25, color: Color.fromARGB(255, 55, 102, 84)),
                      )),
                ),
                const SizedBox(width: 10),
                Container(
        ...
        // User Info StreamBuilder logic here.
                      ...
                      children: [
                          ...
                          children: [
                            Text(
                              ...
                              style: const TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Color.fromARGB(255, 40, 94, 76),
                              ),
                            ),
                            // IconButton(
                            //     onPressed: () =>
                        ...
                        Text(user.email!,
                            ...
                            style: const TextStyle(
                                fontSize: 15,
                                fontWeight: FontWeight.bold,
                                color: Color.fromARGB(255, 39, 92, 70))),
                      ],
                    ),
  ...
  Widget buildPostContainer(
    ...
    return Container(
      ...
      child: Column(
        children: [
          // post title and description row
          Row(
            children: [
              Column(
                children: [
                  post['image'] != null
                      ? WidgetZoom(
                          ...
                          zoomWidget: Image.network(post['image'],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.georama(
                        fontSize: 10,
                        color: const Color.fromARGB(255, 25, 102, 89),
                      ),
                    ),
                    const Divider(
                      color: Color.fromARGB(255, 66, 129, 121),
                      indent: 15,
                      endIndent: 15,
                    ),
                    Text(
                      ...
                      style: GoogleFonts.georama(
                        fontSize: 10,
                        color: Color.fromARGB(255, 16, 66, 58),
                      ),
                    ),
                  ],
                ),
            ...
            children: [
              IconButton(
                ...
                icon: Icon(Icons.favorite_rounded,
                    color: isLiked ? Colors.red : Colors.black, size: 10),
              ),
              ...
              Material(
                  ...
                  child: InkWell(
                      customBorder: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(20)),
                      onTap: () {
                        displayDeleteDialog(context, post);
                      },
                      child: Ink(
                        child: const Icon(
                          Icons.delete_forever_rounded,
                          size: 15,
                          color: Color.fromARGB(255, 35, 141, 123),
                        ),
                      )))
            ],
          )
